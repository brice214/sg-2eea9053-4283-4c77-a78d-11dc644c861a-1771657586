...
import { ArrowLeft, Save, AlertCircle, CheckCircle2, Shield } from "lucide-react";
import { Alert, AlertDescription } from "@/components/ui/alert";

export default function CreateDCRH() {
  ...
  const [dcrhBlocked, setDcrhBlocked] = useState(false);
  ...
  const checkAuth = async () => {
    ...
    // Vérifier s'il y a déjà un DCRH actif
    const { exists } = await adminService.checkActiveDCRH(profile.ministere_id);
    if (exists) {
      setDcrhBlocked(true);
      setError("Un DCRH est déjà actif. Vous devez d'abord le verrouiller depuis le dashboard admin avant de créer un nouveau DCRH.");
      setLoading(false);
      return;
    }
  ...
  if (dcrhBlocked) {
    return (
      <>
        <SEO
          title="Créer un DCRH - USSALA"
          description="Création d'un nouveau DCRH"
        />
  ...
  return (
    <>
      <SEO
        title="Créer un DCRH - USSALA"
        description="Création d'un nouveau DCRH (Direction Centrale des Ressources Humaines)"
      />
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Direction Centrale des Ressources Humaines</p>
        ...
        <main className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          {success && (
            <Alert className="mb-6 bg-green-50 border-green-200 text-green-800">
              ...
              <AlertDescription>
                DCRH créé avec succès ! Redirection en cours...
              </AlertDescription>
            </Alert>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>État civil du DCRH</CardDescription>
              </CardHeader>
            ...
            <div className="flex justify-end gap-4">
              ...
              <Button type="submit" disabled={submitting} className="bg-green-600 hover:bg-green-700">
                ...
                {submitting ? "Création en cours..." : "Créer le DCRH"}
              </Button>
            </div>
          </form>
        </main>
